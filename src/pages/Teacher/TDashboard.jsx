...
export default function TDashboard() {
  ...
  const options = [
    ...
    { value: 'Faculty Conference Publication', label: 'Faculty Conference Publication' },
    { value: 'Grants', label: 'Grants' },
    { value: 'Consultancy Report', label: 'Consultancy Report' },
    { value: 'Patent Publication', label: 'Patent Publication' },
    { value: 'Conferences, Seminars, Workshops, FDP, STTP Organized /conducted', label: 'Conferences, Seminars, Workshops, FDP, STTP Organized /conducted' },
    { value: 'STTP/FDP/Workshop/Conference Attended', label: 'STTP/FDP/Workshop/Conference Attended' },
    { value: 'Webinar/Guest-Expert Lecture / Video conference /Invited talks organized /conducted', label: 'Webinar/Guest-Expert Lecture / Video conference /Invited talks organized /conducted' },
    { value: 'Number of MoUs, collaborations / linkages for Faculty exchange', label: 'Number of MoUs, collaborations / linkages for Faculty exchange' },
    { value: 'Certificate Courses', label: 'Certificate Courses' },
    { value: 'Professional Affiliations', label: 'Professional Affiliations' },
    { value: 'Faculty as Resource Person you', label: 'Faculty as Resource Person you' },
    { value: 'Extension Activity', label: 'Extension Activity' },
    { value: 'Technical Competitions / Tech Fest Organized/Extra & Co-curricular activities Organized', label: 'Technical Competitions / Tech Fest Organized/Extra & Co-curricular activities Organized' },
    { value: 'Faculty Achievement', label: 'Faculty Achievement' },
    { value: 'Industrial Visits / Tours / Field Trip', label: 'Industrial Visits / Tours / Field Trip' },
  ...
  const optionComponents = {
    ...
    "Conferences, Seminars, Workshops, FDP, STTP Organized /conducted": ConfeSeminar,
    "STTP/FDP/Workshop/Conference Attended": Attended,
    "Webinar/Guest-Expert Lecture / Video conference /Invited talks organized /conducted": WebinarConducted,
    "Number of MoUs, collaborations / linkages for Faculty exchange": FacultyExchange,
    ...
    "Technical Competitions / Tech Fest Organized/Extra & Co-curricular activities Organized": TechnicalCompetitions,
  ...
  return (
    <>
      ...
      {selectedOption ? (
        ...
        // Render the Grants component by default
        <FacultyAchievements />
      )}
    </>
  );
